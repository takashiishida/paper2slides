...
def compile_latex(tex_file_path: str, output_directory: str) -> None:
    ...
    :param tex_file_path: Path to the LaTeX file
    :param output_directory: Directory to save the compiled PDF
    """
    try:
        subprocess.run(["pdflatex", tex_file_path], check=True, cwd=output_directory)
